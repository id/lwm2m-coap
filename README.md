# Generic Erlang CoAP Client/Server [![Build status](https://github.com/emqx/lwm2m-coap/actions/workflows/main.yaml/badge.svg)](https://github.com/emqx/lwm2m-coap/actions/workflows/main.yaml)
